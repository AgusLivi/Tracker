...
const filtroPorEdad = (edad) => {
  // Tu código aquí
  const filtrados = utils.personajes.filter(personaje => personaje.edad <= edad)
  if(filtrados.length === 0) throw new Error("No hay personajes igual o menores a la edad solicitada")
  return filtrados
};
