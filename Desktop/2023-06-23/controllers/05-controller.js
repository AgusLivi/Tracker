...
const ordenarPorEdad = () => {
  // Tu código aquí
  if(utils.personajes.length === 0) throw new Error("No se encontraron personajes")
  const ordenados = utils.personajes.sort((personajeA,personajeB) => personajeB.edad - personajeA.edad)
  return ordenados
};
